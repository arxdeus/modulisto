...
extension StreamPipelineLinkerExt on PipelineRef {
  StreamPipelineLinker<T> stream<T>(Stream<T> stream) =>
      StreamPipelineLinker._(stream, this);
}

class StreamPipelineLinker<T>
    implements PipelineLinker<Stream<T>, T>, PipelineRefHost {
