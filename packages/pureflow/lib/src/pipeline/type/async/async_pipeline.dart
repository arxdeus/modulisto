...
import 'package:pureflow/src/pipeline/type/async/async_pipeline_context.dart';
import 'package:pureflow/src/pipeline/type/async/async_pipeline_intent.dart';
...
@internal
final class AsyncPipeline extends PipelineUnit
  ...
  AsyncPipeline(
    ...
    EventTransformer? transformer,
            ...
            transformer ?? <A>(source, mapper) => source.asyncExpand(mapper);
  ...
  void Function(T value) $handle<T>(
    ...
    void intentCallback(T value) {
      ...
      final intent = RawAsyncPipelineIntent(
        ...
        unit: intentSource,
        payload: value,
        task: (MutatorContext context, Object? value) =>
            handler(context, value as T),
        context: context,
      );
  ...
  @override
  String toString() =>
      'AsyncPipeline(debugName: $debugName, module: ${module})';
}
